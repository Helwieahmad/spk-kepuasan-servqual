	...
	function Semua_kriteria(){
		...
		if($query->num_rows()>0){
			...
			foreach($query->result_array() as $value){
				...
				$this->hasil.="<td><a href='".base_url()."saya-disembunyikan/kriteria/$value[id_kriteria]' class='btn btn-primary btn-sm' id='$value[id_kriteria]'><i class='fa fa-pencil-square-o'></i></a>
