	...
	function Semua_kuisioner(){
		...
		if($query->num_rows()>0){
			...
			foreach($query->result_array() as $value){
				...
				$this->hasil.="<td><a href='".base_url()."saya-disembunyikan/kuisioner/$value[id_kuisioner]' class='btn btn-primary btn-sm' id='$value[id_kuisioner]'><i class='fa fa-pencil-square-o'></i></a>
