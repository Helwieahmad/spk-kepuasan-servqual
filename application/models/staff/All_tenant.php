	...
	function Semua_tenant(){
		...
		if($query->num_rows()>0){
			...
			foreach($query->result_array() as $value){
				...
				$fotbut="<a class='btn btn-sm bg-purple foto' data-toggle='modal' data-target='#modal-foto'><i class='fa fa-photo'></i></a>";
				$this->hasil.="<td>$fotbut <a href='".base_url()."staff/edit_tenant/$value[id_tenant]' class='btn bg-purple btn-sm' id='$value[id_tenant]'><i class='fa fa-pencil-square-o'></i></a>
