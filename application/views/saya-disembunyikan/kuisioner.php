                    ...
                    <div class='form-group'>
                        <label for='periode'>Periode Kuisioner</label>
                          <select class='form-control' id='periode'>
                              <?php
                                  if ($periode==1) {
                                    echo"<option value='0'>Pilih Periode</option><option selected value='1'>Semester Ganjil</option><option value='2'>Semester Genap</option>";
                                  }elseif ($periode==2) {
                                    echo "<option value='0'>Pilih Periode</option><option value='1'>Semester Ganjil</option><option selected value='2'>Semester Genap</option>";
                                  }else{
