            ...
            <div class="modal-body">
                        ...
                        <div class='form-group'>
                                ...
                                <div class='input-group has-feedback'><span class="input-group-addon" id="editpassword"><i class='fa fa-lock'></i></span>
                                  <input type='password' class='form-control' id='editpassword' placeholder='password' placeholder='username' data-toggle='tooltip' data-placement='top' title='Minimal 5 karakter' ><span class='form-control-feedback'></span>
                                </div>
                        </div>
