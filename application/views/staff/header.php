<?php
    ...
    $levela=($user_level=='2')?"Administrator":"Staff";
?>
<!DOCTYPE html>
<html>
  <head>
  ...
  <?php } ?>
    ...
    <script type="text/javascript">
        ...
        $(window).load(function() {
          ...
          $(".poter-staff").fadeOut("slow");;
        });
    </script>
  </head>  
  <body class="skin-purple sidebar-mini">
  <div class="poter-staff">
      <div class="spinner">
      </div>
    </div>
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="<?php echo base_url() ?>staff/all_user" class="btn btn-default btn-flat">Profil</a>
                    </div>
                    <div class="pull-right">
                      <a href="<?php echo base_url() ?>staff/logout" class="btn btn-default btn-flat">Sign out</a>
                    </div>
                  </li>
                </ul>
              </li>
