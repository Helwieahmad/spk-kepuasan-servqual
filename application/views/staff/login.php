  ...
  <body class="login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="<?php echo base_url() ?>staff/login"><span class="text-purple">SPK LABKOM</span> </a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        ...
        ?>
        <form action="<?php echo base_url() ?>staff/proseslogin" method="POST">
          ...
          <div class="row">
            <div class="col-xs-4">
              <button type="submit" class="btn bg-purple">Sign In</button>
            </div><!-- /.col -->
          </div>
