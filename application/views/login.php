...
<html>
  <head>
    <meta charset="UTF-8">
    <title>SPK Analisa Kepuasan Pengunjung Laboratorium Komputer UNIKAMA | Log in</title>
  ...
  <body class="login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="<?php echo base_url() ?>tenant/login"><span class="text-orange">SPK LABKOM</span> </a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        ...
        <form action="<?php echo base_url() ?>tenant/proseslogin" method="POST">
          <div class="form-group has-feedback">
            <input type="text" class="form-control" required='required' name='npm' placeholder="NPM / NIDN / NIK"/>
          ...
          <div class="row">
              ...
              <div class="col-xs-8">
                <span class='pull-right' ><a class="btn btn-info-flat text-orange" href="<?php echo base_url()?>tenant/register">Daftar Menjadi Tenant</a></span>
              </div>
            </div>
          </div>
